...
set C_modelName {load_input20}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_data_V int 32 regular {axi_s 0 volatile  { in1 Data } }  }
	{ in_keep_V int 4 regular {axi_s 0 volatile  { in1 Keep } }  }
	{ in_strb_V int 4 regular {axi_s 0 volatile  { in1 Strb } }  }
	{ in_user_V int 4 regular {axi_s 0 volatile  { in1 User } }  }
	{ in_last_V int 1 regular {axi_s 0 volatile  { in1 Last } }  }
	{ in_id_V int 5 regular {axi_s 0 volatile  { in1 ID } }  }
	{ in_dest_V int 5 regular {axi_s 0 volatile  { in1 Dest } }  }
	{ size int 32 regular {fifo 0}  }
	{ size_out int 32 regular {fifo 1}  }
	{ in1_stream_V float 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in1_stream_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ in1_stream_V_din sc_out sc_lv 32 signal 9 } 
	{ in1_stream_V_full_n sc_in sc_logic 1 signal 9 } 
	{ in1_stream_V_write sc_out sc_logic 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in1_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in_data_V", "role": "default" }} , 
 	{ "name": "in1_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "in_dest_V", "role": "" }} , 
 	{ "name": "in1_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "in_dest_V", "role": "" }} , 
 	{ "name": "in1_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_keep_V", "role": "default" }} , 
 	{ "name": "in1_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_strb_V", "role": "default" }} , 
 	{ "name": "in1_TUSER", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_user_V", "role": "default" }} , 
 	{ "name": "in1_TLAST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "in_last_V", "role": "default" }} , 
 	{ "name": "in1_TID", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "in_id_V", "role": "default" }} , 
 	{ "name": "in1_TDEST", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "in_dest_V", "role": "default" }} , 
 	...
 	{ "name": "in1_stream_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in1_stream_V", "role": "din" }} , 
 	{ "name": "in1_stream_V_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in1_stream_V", "role": "full_n" }} , 
 	{ "name": "in1_stream_V_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in1_stream_V", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			...
			{"Name" : "in1_stream_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	in_data_V { axis {  { in1_TDATA in_data 0 32 } } }
	in_keep_V { axis {  { in1_TKEEP in_data 0 4 } } }
	in_strb_V { axis {  { in1_TSTRB in_data 0 4 } } }
	in_user_V { axis {  { in1_TUSER in_data 0 4 } } }
	in_last_V { axis {  { in1_TLAST in_data 0 1 } } }
	in_id_V { axis {  { in1_TID in_data 0 5 } } }
	in_dest_V { axis {  { in1_TVALID in_vld 0 1 }  { in1_TREADY in_acc 1 1 }  { in1_TDEST in_data 0 5 } } }
	...
	in1_stream_V { ap_fifo {  { in1_stream_V_din fifo_data 1 32 }  { in1_stream_V_full_n fifo_status 0 1 }  { in1_stream_V_write fifo_update 1 1 } } }
}
