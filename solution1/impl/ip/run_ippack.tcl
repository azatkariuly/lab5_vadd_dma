...
set sdx_kernel_name "krnl_vadd"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/QCH170308/Desktop/saxpy_dma/lab5_vadd_dma_azaz/solution1"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 a W 0x0 "Data signal of a" {{0 32 a W 0 "Bit 31 to 0 Data signal of a"}}} {0x18 size W 0x0 "Data signal of size" {{0 32 size W 0 "Bit 31 to 0 Data signal of size"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS in1 in2 out_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 4112 II x}
